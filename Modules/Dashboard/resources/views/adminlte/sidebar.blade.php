    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2"> <!--begin::Sidebar Menu-->
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                @can('view roles')
                    <li class="nav-item  "> <a href="#roles" class="nav-link  "> <i class="nav-icon bi bi-speedometer"></i>
                            <p>
                                Roles
                                <i class="nav-arrow bi bi-chevron-right"></i>
                            </p>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item"> <a href="{{ route('roles.index') }}" class="nav-link  "> <i
                                        class="nav-icon bi bi-circle"></i>
                                    <p>List</p>
                                </a>
                            </li>
                            <li class="nav-item"> <a href="{{ route('roles.create') }}" class="nav-link"> <i
                                        class="nav-icon bi bi-circle"></i>
                                    <p>Create</p>
                                </a>
                            </li>
                ...
                @endcan
                <li class="nav-item  "> <a href="#company" class="nav-link  "> <i
                            class="nav-icon bi bi-speedometer"></i>
                        <p>
                            Company
                            <i class="nav-arrow bi bi-chevron-right"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item"> <a href="{{ route('company.index') }}" class="nav-link  "> <i
                                    class="nav-icon bi bi-circle"></i>
                                <p>List</p>
                            </a>
                        </li>
                        <li class="nav-item"> <a href="{{ route('company.create') }}" class="nav-link"> <i
                                    class="nav-icon bi bi-circle"></i>
                                <p>Create</p>
                            </a>
                        </li>
                        <li class="nav-item"> <a href="{{ route('department.index') }}" class="nav-link"> <i
                                    class="nav-icon bi bi-palette"></i>
                                <p>Department Index</p>
                            </a> </li>
                    </ul>
                </li>

                @can('view permissions')
                    <li class="nav-item  "> <a href="#permission" class="nav-link  "> <i
                                class="nav-icon bi bi-speedometer"></i>
                            <p>
                                Permissions
                                <i class="nav-arrow bi bi-chevron-right"></i>
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item"> <a href="{{ route('permission.create') }}" class="nav-link"> <i
                                        class="nav-icon bi bi-circle"></i>
                                    <p>Create</p>
                                </a>
                            </li>
                ...
                <li class="nav-item  "> <a href="#tasks" class="nav-link  "> <i
                            class="nav-icon bi bi-speedometer"></i>
                        <p>
                            Tasks
                            <i class="nav-arrow bi bi-chevron-right"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item"> <a href="{{ route('tasks.index') }}" class="nav-link  "> <i
                                    class="nav-icon bi bi-circle"></i>
                                <p>Tasks List</p>
                            </a>
                        </li>
                        <li class="nav-item"> <a href="{{ route('tasks.create') }}" class="nav-link"> <i
                                    class="nav-icon bi bi-circle"></i>
                                <p>Create</p>
                            </a>
                        </li>
