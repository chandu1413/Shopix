...
<head>
    ...
    <meta name="title" content="OrgManager | Dashboard">
    <meta name="author" content="Chandu">
    <meta name="description" content=" ">
    <meta name="keywords" content=" ">
    <!--end::Primary Meta Tags-->
     <!--begin::toastr CSS-->
    <link rel="stylesheet" href="{{ asset('vendor/flasher/toastr.css') }}">
    <!--end::toastr CSS-->
    <!--begin::Fonts-->
    ...
    <link rel="stylesheet" href="{{ Module::asset('dashboard:css/adminlte/adminlte.css') }}">
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        @include('dashboard::adminlte.navbar')
        @include('dashboard::adminlte.sidebar')
        <main class="app-main"> <!--begin::App Content Header-->

            <div class="app-content-header"> <!--begin::Container-->
                <div class="container-fluid pt-3"> <!--begin::Row-->
...
<!-- Scripts -->
    ...
    <script src="{{ Module::asset('dashboard:js/adminlte/adminlte.js') }}"></script> <!--end::Required Plugin(AdminLTE)--><!--begin::OverlayScrollbars Configure-->
    {{-- <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script> --}}
    @yield('scripts')
    <script>
...
<!-- Include Toastr JS -->
<script src="{{ asset('vendor/flasher/toastr.js') }}"></script>
